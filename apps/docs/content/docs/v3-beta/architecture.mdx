...
See [S3 Providers](/docs/v3-beta/s3-providers) for setup instructions when using external storage.
...
- Enable external S3 storage by setting `ENABLE_S3=true`, see [S3 Providers](/docs/v3-beta/s3-providers) for more information.
