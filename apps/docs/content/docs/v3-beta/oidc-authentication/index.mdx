...
- **[Google](/docs/v3-beta/oidc-authentication/google)**
- **[Discord](/docs/v3-beta/oidc-authentication/discord)**
- **[Github](/docs/v3-beta/oidc-authentication/github)**
- **[Zitadel](/docs/v3-beta/oidc-authentication/zitadel)**
- **[Auth0](/docs/v3-beta/oidc-authentication/auth0)**
- **[Authentik](/docs/v3-beta/oidc-authentication/authentik)**
- **[Frontegg](/docs/v3-beta/oidc-authentication/frontegg)**
- **[Kinde Auth](/docs/v3-beta/oidc-authentication/kinde-auth)**
