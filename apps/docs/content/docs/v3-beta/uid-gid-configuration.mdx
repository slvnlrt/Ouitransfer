...
services:
  OUITRANSFER:
    ...
    environment:
      ...
      - STORAGE_URL="https://your-domain:9000"
    ports:
      - "9000:9000"
      - "5487:5487"
    volumes:
...
services:
  OUITRANSFER:
    ...
    environment:
      ...
      - OUITRANSFER_GID=100
      - STORAGE_URL="https://your-synology-nas:9000"
    ports:
      - "9000:9000"
      - "5487:5487"
    volumes:
      - /volume1/docker/OUITRANSFER:/app/server
    restart: unless-stopped
```
...
services:
  OUITRANSFER:
    ...
    environment:
      - OUITRANSFER_UID=1000
      - OUITRANSFER_GID=100
      - STORAGE_URL="https://your-qnap-nas:9000"
    ports:
      - "9000:9000"
      - "5487:5487"
    volumes:
      - /share/Container/OUITRANSFER:/app/server
    restart: unless-stopped
```
...
docker-compose logs OUITRANSFER | grep -E "🔧|Runtime UID/GID"

# Check file ownership inside container
docker exec OUITRANSFER ls -la /app/server/
```
...
docker-compose logs OUITRANSFER | head -20

# Check file ownership in container
docker exec OUITRANSFER ls -la /app/server/

# Verify process is running with correct UID/GID
docker exec OUITRANSFER ps aux | grep node

# Check environment variables
docker exec OUITRANSFER env | grep OUITRANSFER
```
