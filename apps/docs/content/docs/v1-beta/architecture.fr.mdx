...
| `ENCRYPTION_SECRET` | Facultatif (min 32 caractères); clé AES-256-GCM pour le chiffrement des données sensibles (mot de passe de liaison LDAP). Requis si LDAP est activé |
