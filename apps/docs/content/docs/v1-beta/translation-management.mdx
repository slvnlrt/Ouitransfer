...
<Callout type="warn">
  **"100% completeness" does not mean fully translated.** The check script only detects strings
  ...
  review the **"Possible matches"** column — strings identical to English that may need human
  translation.
</Callout>
...
--------------------------------------------------------------------------------
✅ pt-BR         100.0%       1958/1958         0 (0.0%)        378
✅ fr-FR         100.0%       1958/1958         0 (0.0%)        166
🟡 de-DE         95.2%        1866/1958         0 (0.0%)        384
================================================================================
```
