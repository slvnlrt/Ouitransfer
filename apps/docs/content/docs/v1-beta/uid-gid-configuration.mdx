...
**⚠️ Important**: OUITRANSFER uses **UID 1001, GID 1001** by default. Many Linux systems use UID/GID 1000 for the first user, which creates a mismatch and causes permission issues with bind mounts.

## The Permission Problem

### Why This Happens

- **OUITRANSFER Default**: UID 1001, GID 1001 (container)
- **Linux Standard**: UID 1000, GID 1000 (most host systems)
- **Result**: Mismatch causes permission errors on bind-mounted directories
