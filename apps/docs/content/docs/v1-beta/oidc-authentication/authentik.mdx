...
<ZoomableImage src="/assets/v1/oidc/authentik/sign-in-with-authentik.png" alt="Sign in with Authentik" />
...
<ZoomableImage src="/assets/v1/oidc/authentik/authentik-admin.png" alt="Authentik Admin Interface" />

2. **Create new OAuth2/OpenID Provider**: Click **"Applications"** in the left sidebar, then click **"Providers"** and click **"+ Create"**

<ZoomableImage src="/assets/v1/oidc/authentik/create-provider.png" alt="Authentik Create Provider" />
...
<ZoomableImage src="/assets/v1/oidc/authentik/enabled-authentik.png" alt="OUITRANSFER Authentik Provider Enabled" />
...
<ZoomableImage src="/assets/v1/oidc/authentik/authentik-icon.png" alt="Authentik Icon" />
