...
<ZoomableImage src="/assets/v1/oidc/auth0/sign-in-with-auth0.png" alt="Sign in with Auth0" />
...
<ZoomableImage src="/assets/v1/oidc/auth0/auth0-dashboard.png" alt="Auth0 Dashboard" />

2. **Create new application**: Click **"Applications"** in the left sidebar, then click **"+ Create Application"**

<ZoomableImage src="/assets/v1/oidc/auth0/create-application.png" alt="Auth0 Create Application" />
...
<ZoomableImage src="/assets/v1/oidc/auth0/enabled-auth0.png" alt="OUITRANSFER Auth0 Provider Enabled" />
...
<ZoomableImage src="/assets/v1/oidc/auth0/auth0-icon.png" alt="Auth0 Icon" />
