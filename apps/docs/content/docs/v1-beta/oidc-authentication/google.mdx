...
<ZoomableImage src="/assets/v1/oidc/google/sign-in-with-google.png" alt="Sign in with Google" />
...
<ZoomableImage src="/assets/v1/oidc/google/cloud-console-home.png" alt="Google Cloud Console Home" />

2. **Create or select a project**: Choose an existing project or create a new one for your OUITRANSFER installation

<ZoomableImage src="/assets/v1/oidc/google/select-project-modal.png" alt="Google Cloud Console Select Project Modal" />
...
<ZoomableImage src="/assets/v1/oidc/google/user-type-select.png" alt="Google Cloud Console User Type Select" />
...
<ZoomableImage src="/assets/v1/oidc/google/credentials-select.png" alt="Google Cloud Console Credentials select" />
...
<ZoomableImage src="/assets/v1/oidc/google/web-app-select.png" alt="Google Cloud Console Web App Select" />
...
<ZoomableImage src="/assets/v1/oidc/google/allowed-urls.png" alt="Google Cloud Console Allowed URLs" />
...
<ZoomableImage src="/assets/v1/oidc/google/OUITRANSFER-enabled-google.png" alt="OUITRANSFER Authentication Providers" />
...
<ZoomableImage src="/assets/v1/oidc/google/edit-google.png" alt="Edit Google Provider" />
...
<ZoomableImage src="/assets/v1/oidc/google/google-icon.png" alt="Google Icon" />
