 ...
 * Shared between frontend and backend (adapted from server version)
...
export function extractFilenameFromContentDisposition(contentDisposition: string | null): string | null {
  ...
  // Format: attachment; filename="example.mp3"; filename*=UTF-8''example.mp3
...
export function detectMimeTypeWithFallback(
  ...
  // If server provides a proper Content-Type, use it
  ...
  // Fall back to provided filename
