...
All resolved: B-1 through B-19, TD-1, TD-2, TD-3, TD-4, TD-7, TD-8, TD-9, TD-12, TD-13, TD-14, TD-15.

**Test counts:** 44 server test files (426 tests) + 19 web test files (222 tests) + 2 shared (14 tests) = **662 total**.

**Open tech debt:** TD-5, TD-6, TD-10, TD-11, TD-16 — see `TECHNICAL-DEBT.md`
