...
**Addendum 3 (LDAP default email language, juin 2026) :** ajout de `ldap.config.defaultLocaleLabel` +
`ldap.config.defaultLocaleDescription` dans les 23 locales — `en-US` et `fr-FR` traduits, 21
placeholders anglais. Même périmètre TD-36.
