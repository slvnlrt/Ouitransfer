...
**Symptôme :** Le footer affiche "Propulsé par Ouitransfer" avec un lien vers `https://example.com/` au lieu de `https://example.com/`.
...
1. Changer l'URL vers `https://example.com/`
