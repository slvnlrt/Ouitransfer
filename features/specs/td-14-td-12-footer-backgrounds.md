...
| `footerText` | `text` | `Burger&Cie` | Text displayed after "Powered by" |
| `footerUrl` | `text` | `https://burgeretcie.fr` | Link URL |
...
Both currently hardcode `Burger&Cie` and `https://burgeretcie.fr`. Change to:
